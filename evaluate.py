...
def main():
    ...
    optimization_result_path = f'/home/xuwenbo/code/ICAF-4/log/{dataset}_log/icaf_log_{cat}/refined_results/refined_results.h5'
    combined_result_path = optimization_result_path
    output_dir = f'/home/xuwenbo/code/ICAF-4/log/{dataset}_log/icaf_log_{cat}/prediction_results'
