...
def optimize_with_kinematic(ins, ins_ancsh, ins_npcs, num_parts, niter, choose_threshold, log, gt=False, do_eval=True):
    ...
    pred_naocs_per_point = ins_ancsh[f"{prefix}naocs_per_point"]  #pred_naocs
    ...
    gt_rt = []
    gt_scale = []
    gt_seg_per_point = ins_ancsh['gt_seg_per_point']
    gt_npcs_per_point = ins_ancsh['gt_npcs_per_point']
    gt_partIndex = []
    ...
    gt_naocs_rt = []
    gt_naocs_scale = []
    gt_naocs_per_point = ins_ancsh['gt_naocs_per_point']
    for i in range(num_parts):
